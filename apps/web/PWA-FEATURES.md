...
The app uses `@serwist/next` (the official Next.js recommended PWA solution) with Serwist that implements intelligent caching strategies:
...
└── public/
    ├── sw.js                         # Generated service worker (by Serwist)
