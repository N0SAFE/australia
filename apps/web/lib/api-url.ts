...
/**
 * Get the full Storage URL for a given file path
 * @param path - Storage path (e.g., '/files/image.png', 'files/video.mp4')
 * @returns Full Storage URL
 * 
 * @example
 * getStorageUrl('/files/image.png')
 * // Browser: 'http://localhost:3001/storage/files/image.png'
 * // Server: 'http://api:3001/storage/files/image.png'
 */
